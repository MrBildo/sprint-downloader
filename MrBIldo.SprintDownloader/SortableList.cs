...
namespace MrBildo.SprintDownloader
{
    public class SortableBindingList<T> : BindingList<T>
    {
        ...
        protected override PropertyDescriptor SortPropertyCore => _sortProperty ?? throw new InvalidOperationException();
        ...
        internal class PropertyComparer : Comparer<T>
        {
            ...
            public static bool CanSort(Type type) => CanSortWithToString(type) || CanSortWithIComparable(type);

            private static bool CanSortWithIComparable(Type type) => type.GetInterface("IComparable") != null ||
    ...
    {
        public static BindingList<T> ToSortableBindingList<T>(this IEnumerable<T> source) => new SortableBindingList<T>(source.ToList());
    }
}
